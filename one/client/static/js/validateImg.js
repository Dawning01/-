$(document).on("click",".validateMostDiv",function(){
...
var button = document.getElementById("phoneNoteNext");//获取按钮

var input = document.getElementById ("eamillInput");//获取输入框

var validateMostDiv = document.getElementById("validateMostDiv"); //获取图片验证码跟换一下总盒子

// var newValidateMostDiv=document.getElementById("newValidateMostDiv");

context.clearRect(0, 0, 120, 40);
draw();
validateMostDiv.onclick = function () {
...
//        $('#newPhoneForm').css('display','block')
